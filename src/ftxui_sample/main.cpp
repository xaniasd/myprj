...
// configuration step. It creates a namespace called `myprj`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", myprj::cmake::project_name, myprj::cmake::project_version) };
